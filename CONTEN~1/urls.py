"""content_detection_and_classification_of_youtube_videos URL Configuration
...
from content_detection_and_classification_of_youtube_videos import settings
...
urlpatterns = [
    ...
    url(r'^Predict_YouTube_Content_Type/$', remoteuser.Predict_YouTube_Content_Type, name="Predict_YouTube_Content_Type"),
    ...
    url(r'^View_Prediction_Of_YouTube_Content_Ratio/$', serviceprovider.View_Prediction_Of_YouTube_Content_Ratio, name="View_Prediction_Of_YouTube_Content_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_YouTube_Content_Type/$', serviceprovider.View_Prediction_Of_YouTube_Content_Type, name="View_Prediction_Of_YouTube_Content_Type"),
